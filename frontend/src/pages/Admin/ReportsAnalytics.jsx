    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-white p-4 rounded-xl shadow">
          <h2 className="font-semibold mb-2">Vehicle Rentals</h2>
          <Bar 
            data={{ 
              labels: Object.keys(vehicleCounts), 
              datasets: [{ label: 'Times Rented', data: Object.values(vehicleCounts), backgroundColor: '#093C5D' }] 
            }} 
            options={chartOptions} 
          />
        </div>
        <div className="bg-white p-4 rounded-xl shadow">
          <h2 className="font-semibold mb-2">Guide Bookings</h2>
          <Bar 
            data={{ 
              labels: Object.keys(guideCounts), 
              datasets: [{ label: 'Bookings', data: Object.values(guideCounts), backgroundColor: '#3B7597' }] 
            }} 
            options={chartOptions} 
          />
        </div>
        <div className="bg-white p-4 rounded-xl shadow lg:col-span-2">
          <h2 className="font-semibold mb-2">Hotel Bookings</h2>
          <Bar 
            data={{ 
              labels: Object.keys(hotelCounts), 
              datasets: [{ label: 'Bookings', data: Object.values(hotelCounts), backgroundColor: '#5DF8D8' }] 
            }} 
            options={chartOptions} 
          />
        </div>
