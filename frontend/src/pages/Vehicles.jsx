...
import { Car, Eye, Users, Fuel, Calendar, Search, Star, MapPin, Shield, Heart } from 'lucide-react'; // removed Clock
  ...
  <div className="group bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 relative">
    ...
    <div className="p-5">
      ...
      <div className="flex items-center justify-between pt-3 border-t border-gray-100">
        ...
        <button onClick={() => onViewDetails(vehicle)} className="bg-primary text-white px-4 py-2 rounded-xl hover:bg-secondary transition-all duration-300 flex items-center gap-2 shadow-md hover:shadow-lg">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cream to-gray-100">
            ...
            {totalPages > 1 && (
              <div className="flex justify-center items-center gap-6 mt-12">
                <button
                  ...
                  disabled={page === 1}
                  className="btn-outline px-6 py-2 disabled:opacity-40 transition"
                >
                  Previous
                </button>
      ...
      <VehicleDetailModal
        ...
        onAddFeedback={addVehicleFeedback}
      />
    </div>
  );
};
