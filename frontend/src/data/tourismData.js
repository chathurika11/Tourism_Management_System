// Shared data for all pages with high-quality images and pricing details

export const tourPackages = [
  { 
    id: 1, name: 'Cultural Triangle Tour', location: 'Kandy, Sigiriya', district: 'Kandy', rating: 4.8, 
  ...
  { 
    id: 2, name: 'Galle Day Tour', location: 'Galle Fort', district: 'Galle', rating: 4.5, 
  ...
  { 
    id: 3, name: 'Ella Escape', location: 'Ella', district: 'Ella', rating: 4.9, 
  ...
  { 
    id: 4, name: 'Nuwara Eliya Highlands', location: 'Nuwara Eliya', district: 'Nuwara Eliya', rating: 4.7, 
...
export const calculatePackagePricing = (tour) => {
  const days = tour.duration.split(' ')[0] || 5;
  const parsedDays = parseInt(days);
  
  const hotelPricePerNight = tour.includes.hotel.pricePerNight;
  const vehiclePricePerDay = tour.includes.vehicle.pricePerDay;
  const guidePricePerDay = tour.includes.guide.pricePerDay;
  const serviceCharge = 15000;
  const discountPercent = 5;
  
  const hotelTotal = hotelPricePerNight * parsedDays;
  const vehicleTotal = vehiclePricePerDay * parsedDays;
  const guideTotal = guidePricePerDay * parsedDays;
  ...
  return {
    days: parsedDays,
    hotel: { name: tour.includes.hotel.name, pricePerNight: hotelPricePerNight, total: hotelTotal },
    vehicle: { name: tour.includes.vehicle.name, type: tour.includes.vehicle.type, pricePerDay: vehiclePricePerDay, total: vehicleTotal },
    guide: { name: tour.includes.guide.name, specialty: tour.includes.guide.specialty, pricePerDay: guidePricePerDay, total: guideTotal },
...
export const vehicles = [
  { id: 1, type: 'Scooter', model: 'Honda Dio', pricePerDay: 2500, passengers: 2, fuelType: 'Petrol', mileage: '45 km/l', year: '2024', popular: true, district: 'Colombo', rating: 4.7, image: 'https://images.pexels.com/photos/1046997/pexels-photo-1046997.jpeg?w=600' },
  { id: 2, type: 'Car', model: 'Honda Fit', pricePerDay: 6000, passengers: 4, fuelType: 'Petrol', mileage: '20 km/l', year: '2023', popular: false, district: 'Colombo', rating: 4.5, image: 'https://images.pexels.com/photos/116675/pexels-photo-116675.jpeg?w=600' },
  { id: 3, type: 'Car', model: 'Toyota Axio', pricePerDay: 6500, passengers: 4, fuelType: 'Petrol', mileage: '18 km/l', year: '2023', popular: true, district: 'Kandy', rating: 4.8, image: 'https://images.pexels.com/photos/116675/pexels-photo-116675.jpeg?w=600' },
  { id: 4, type: 'SUV', model: 'Toyota Prado', pricePerDay: 12000, passengers: 7, fuelType: 'Diesel', mileage: '12 km/l', year: '2024', popular: true, district: 'Ella', rating: 4.9, image: 'https://images.pexels.com/photos/2127733/pexels-photo-2127733.jpeg?w=600' },
  { id: 5, type: 'Van', model: 'Nissan Caravan', pricePerDay: 9000, passengers: 10, fuelType: 'Diesel', mileage: '14 km/l', year: '2023', popular: true, district: 'Galle', rating: 4.4, image: 'https://images.pexels.com/photos/2127733/pexels-photo-2127733.jpeg?w=600' },
  { id: 6, type: 'SUV', model: 'Mitsubishi Montero', pricePerDay: 11000, passengers: 7, fuelType: 'Diesel', mileage: '11 km/l', year: '2023', popular: false, district: 'Kandy', rating: 4.6, image: 'https://images.pexels.com/photos/2127733/pexels-photo-2127733.jpeg?w=600' },
  { id: 7, type: 'Van', model: 'Toyota Hiace', pricePerDay: 10000, passengers: 10, fuelType: 'Diesel', mileage: '13 km/l', year: '2024', popular: false, district: 'Ella', rating: 4.3, image: 'https://images.pexels.com/photos/2127733/pexels-photo-2127733.jpeg?w=600' },
];
...
export const getHotelsByDistrictAndBudget = (district, budget) => {
  ...
  if (budget === 'budget') filteredHotels = filteredHotels.filter(h => h.pricePerNight <= 7000);
  else if (budget === 'mid') filteredHotels = filteredHotels.filter(h => h.pricePerNight > 7000 && h.pricePerNight <= 12000);
  else if (budget === 'luxury') filteredHotels = filteredHotels.filter(h => h.pricePerNight > 12000);
...
export const calculatePackagePricingFn = (tour) => {
  ...
  const hotelTotal = tour.includes.hotel.pricePerNight * days;
  const vehicleTotal = tour.includes.vehicle.pricePerDay * days;
  const guideTotal = tour.includes.guide.pricePerDay * days;
  const serviceCharge = 15000;
  const subtotal = hotelTotal + vehicleTotal + guideTotal + serviceCharge;
